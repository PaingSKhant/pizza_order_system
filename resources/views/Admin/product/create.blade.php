                    ...
                    <div class="card-body ">
                        ...
                        <form action="{{ route('product#create')}}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="waitingTime" value="{{ old('waitingTime')}}" type="number" class="form-control  @error('waitingTime') is-invalid @enderror " aria-required="true" aria-invalid="false" placeholder="Enter Waiting Time... ">
                                @error('waitingTime')
                                <div class="invalid-feedback">
                                    {{$message }}
                                </div>
                            ...
                            <div>
                                <button id="payment-button" type="submit" class="btn btn-lg btn-success btn-block rounded">
